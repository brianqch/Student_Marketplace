        ...
        <>
            <div className="flex flex-col justify-center">
                ...
                <div className="flex flex-col sm:flex-row gap-5 justify-between items-center font-palanquin">
                    <button className="flex grow sm:w-auto w-full items-center px-4 py-4 border border-black hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-500" onClick={handleNextStep}>
                        <AiOutlineShoppingCart className="w-6 h-6" />

                        <span className="flex grow justify-center text-xl">I want to buy!</span>
                    </button>
                    <button className="flex grow sm:w-auto w-full items-center px-4 py-4 border border-black hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-50" onClick={handleNextStep}>
